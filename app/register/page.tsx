  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-zinc-50 via-white to-zinc-100 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950">
      ...
      <div className="flex w-full flex-col lg:flex-row">
        ...
        {/* Left Column - Form */}
        <div className="order-2 flex w-full items-center justify-center p-5 sm:p-8 lg:w-1/2 lg:order-1 lg:p-12">
          <div className="w-full max-w-md">
            {/* Header */}
            <div className="mb-5 sm:mb-8">
              <h1 className="mb-1.5 bg-gradient-to-r from-green-600 via-emerald-500 to-teal-500 bg-clip-text text-2xl font-bold tracking-tight text-transparent sm:mb-2 sm:text-4xl">
                Create Account
              </h1>
